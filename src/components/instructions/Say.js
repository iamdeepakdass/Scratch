  ...
  useEffect(() => {
    dispatch(
      editInstruction({
        ...
        instruction: { uniqueId, action: "say", text: text },
      })
    );
  }, [text]);

  return (
    <div className="flex flex-row flex-wrap items-center justify-between bg-yellow-600 text-white px-2 py-1 my-2 text-sm cursor-pointer">
      <p>
        Say{" "}
        <input
          type="text"
